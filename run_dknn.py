...
from lib.knn_attack import AttackCred, AttackV5
...
m = 500
max_iter = 1000
fname = "adv_pn{}_pb{}_lr{}_c{}_m{}.p".format(
...
min_dist = [0.7484518915597577, 0.742514077896593,
            0.5667317128548899, 0.19457440222463473]
# min_dist = [0.3, 0.3, 0.25, 0.1]

# for pert_bound in [3.476]:

# fname = "cred_adv_pn{}_pb{}_lr{}_c{}_m{}.p".format(
#     pert_norm, pert_bound, lr, init_const, m)
...
# Try to bound l_2 norm of attack
X_adv = attack.attack(
    X_test, y_test, max_iter=max_iter, bin_search_steps=1)
